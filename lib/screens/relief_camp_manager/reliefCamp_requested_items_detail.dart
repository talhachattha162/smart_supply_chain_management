...
class ReliefCampRequestedItemsDetail extends StatefulWidget {
  final RequestedReliefCampItem requestedReliefCampItem;
   ReliefCampRequestedItemsDetail({super.key,required this.requestedReliefCampItem});

  @override
  State<ReliefCampRequestedItemsDetail> createState() => _ReliefCampRequestedItemsDetailState();
}

class _ReliefCampRequestedItemsDetailState extends State<ReliefCampRequestedItemsDetail> {
            ...
            children: [
              ...
              async {
                if(selectedReliefWorker==null){
                  ...
                  await requestedReliefCampItemService.updateRequestedReliefCampItemAssignedReliefWorker(widget.requestedReliefCampItem.id, selectedReliefWorker!);
