...
class DonorNearestReliefCamps extends StatefulWidget {
  @override
  _DonorNearestReliefCampsState createState() => _DonorNearestReliefCampsState();
}

class _DonorNearestReliefCampsState extends State<DonorNearestReliefCamps> with WidgetsBindingObserver{
        ...
        nearestCities.add(Marker(
          ...
          builder: (context) =>
              IconButton(
                  ...
                  onPressed: () =>
                      Navigator.push(context, MaterialPageRoute(builder: (context) => ReliefCampDetails(reliefCamp: nearestCamp,appbar: true),))
        )
        ));
      }
    }
