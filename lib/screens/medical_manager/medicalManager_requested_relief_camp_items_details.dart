...
class MedicalManagerRequestedReliefCampItemsDetail extends StatefulWidget {
  final RequestedReliefCampItem requestedReliefCampItem;
  MedicalManagerRequestedReliefCampItemsDetail({super.key,required this.requestedReliefCampItem});

  @override
  State<MedicalManagerRequestedReliefCampItemsDetail> createState() => _MedicalManagerRequestedReliefCampItemsDetailState();
}

class _MedicalManagerRequestedReliefCampItemsDetailState extends State<MedicalManagerRequestedReliefCampItemsDetail> {
