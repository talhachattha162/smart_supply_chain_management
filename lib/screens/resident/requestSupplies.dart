...
class RSupplyRequestForm extends StatefulWidget {
  @override
  _RSupplyRequestFormState createState() => _RSupplyRequestFormState();
}

class _RSupplyRequestFormState extends State<RSupplyRequestForm> {
