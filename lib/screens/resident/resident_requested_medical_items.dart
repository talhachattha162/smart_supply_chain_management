...
class ResidentRequestedMedicalItems extends StatefulWidget {
  const ResidentRequestedMedicalItems({super.key});

  @override
  State<ResidentRequestedMedicalItems> createState() => _ResidentRequestedMedicalItemsState();
}

class _ResidentRequestedMedicalItemsState extends State<ResidentRequestedMedicalItems> {
  ...
  getRequestedMedicalItems() async {
    ...
    requestedMedicalItems = await requestedMedicalItemService.getAllRequestedMedicalItemsOfUser(UserProvider.userModel!.id);
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: () async {
                      final result=await  Navigator.push(context, MaterialPageRoute(builder: (context) => ResidentRequestedMedicalItemsDetail(requestedMedicalItem:filteredrequestedMedicalItems[index] ),));
                      // if(result==1){
                      //   setState(() {
                      //     isLoading=true;
                      //   });
