...
class ResidentRequestedReliefCampItemsDetail extends StatefulWidget {
  final RequestedReliefCampItem requestedReliefCampItem;
  ResidentRequestedReliefCampItemsDetail({super.key,required this.requestedReliefCampItem});

  @override
  State<ResidentRequestedReliefCampItemsDetail> createState() => _ResidentRequestedReliefCampItemsDetailState();
}

class _ResidentRequestedReliefCampItemsDetailState extends State<ResidentRequestedReliefCampItemsDetail> {
