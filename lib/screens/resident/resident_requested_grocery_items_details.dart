...
class ResidentRequestedGroceryItemsDetail extends StatefulWidget {
  final RequestedGroceryItem requestedGroceryItem;
  ResidentRequestedGroceryItemsDetail({super.key,required this.requestedGroceryItem});

  @override
  State<ResidentRequestedGroceryItemsDetail> createState() => _ResidentRequestedGroceryItemsDetailState();
}

class _ResidentRequestedGroceryItemsDetailState extends State<ResidentRequestedGroceryItemsDetail> {
          ...
          Column(children: [
            ...
            ElevatedButton(onPressed: () async {
              if(_textEditingController.text.isEmpty){
                ...
                await requestedGroceryItemService.updateRequestedGroceryItemRemarks(widget.requestedGroceryItem.id, _textEditingController.text);
